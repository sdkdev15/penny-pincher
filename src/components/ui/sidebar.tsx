      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
            <SheetHeader className="p-4 border-b border-sidebar-border shrink-0"> {/* Added shrink-0 */}
              <SheetTitle className="text-sidebar-foreground">{APP_NAME}</SheetTitle>
            </SheetHeader>
            <div className="flex h-full flex-1 flex-col overflow-y-auto"> {/* Added flex-1 and overflow-y-auto */}
              {children}
            </div>
          </SheetContent>
        </Sheet>
